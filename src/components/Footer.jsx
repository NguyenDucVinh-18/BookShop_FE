          ...
          <div className="footer-content">
            ...
            <div className="footer-column company-info">
              ...
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <span>
                    Văn phòng: LK 02 - 03, Dãy B, KĐT Green Pearl, 378 Minh
                ...
                <div className="contact-item">
                  <EnvironmentOutlined className="contact-icon" />
                  <span>
                    Cửa hàng: Gian hàng HIEU VINH Book tại Phố Sách Hà Nội, Phố
                    19 tháng 12, Hoàn Kiếm, Hà Nội.
                  </span>
                </div>
                <div className="contact-item">
                ...
                <div className="contact-item">
                  <EnvironmentOutlined className="contact-icon" />
                  <span>
                    Chi nhánh Miền Nam: 33 Đỗ Thừa Tự, Tân Quý, Tân Phú, Thành
            ...
            <div className="footer-column facebook-section">
              <h3 className="footer-title">
                KẾT NỐI VỚI HIEUVINH TRÊN FACEBOOK
              </h3>
        ...
        <div className="container">
          <div className="bottom-content">
            ...
            <div className="bottom-right">
              <span>
                © Bản quyền thuộc về Công ty TNHH MTV TM và DV Văn Hoá HIEU VINH
              </span>
            </div>
          </div>
        </div>
